      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px' }}>
        <thead>
          <tr>
            ...
            <th style={{ border: '1px solid #ddd', padding: '8px' }}>SHA256 Checksum</th>
        ...
        <tbody>
          {downloads.map((download, index) => (
            <tr key={index}>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{download.platform}</td>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                <a href={`/${download.file}`} download>{download.file}</a>
              </td>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{download.shaSum}</td>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                <a href={`/${download.signature}`} download>{download.signature}</a>
              </td>
            </tr>
          ))}
        </tbody>
